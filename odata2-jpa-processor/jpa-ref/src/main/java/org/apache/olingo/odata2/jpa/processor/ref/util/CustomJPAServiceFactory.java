...
/**
 * <p>
 * Extend this factory class and create own instance of {@link ODataService} that
 * transforms Java Persistence
 * Models into an OData Service. The factory class instantiates instances of
 * type {@link EdmProvider} and
 * {@link ODataSingleProcessor}. The OData
 ...
 * runtime which will instantiate a {@link ODataService} implementation using this factory.
 * </p>
 *
 * <p>
 * <b>Mandatory:</b> Implement the abstract method initializeODataJPAContext. Fill
 * {@link ODataJPAContext} with context
 * values.
 * </p>
 *
...
public abstract class CustomJPAServiceFactory extends ODataServiceFactory {
   ...
   * {@link ODataJPARuntimeException} is thrown if
   ...
   * For details refer to {@link OnJPAWriteContent}
   * @param onJPAWriteContent is an instance of type
   * {@link OnJPAWriteContent}
   */
